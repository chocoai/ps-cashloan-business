...
public class OpinionController extends BaseController {
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/com/adpanshi/cashloan/api/act/mine/opinion/submit.htm", method = RequestMethod.POST)
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/com/adpanshi/cashloan/api/act/mine/opinion/page.htm", method = RequestMethod.POST)
   public void page(
