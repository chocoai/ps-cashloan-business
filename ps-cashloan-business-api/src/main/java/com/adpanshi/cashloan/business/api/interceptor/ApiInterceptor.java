package com.adpanshi.cashloan.business.api.interceptor;
...
     * 给定字节。
    ...
    static Map<String,Object> during(){
		String switchs=Global.getValue(Constant.SYSTEM_UPGRADE);
		String toast=Global.getValue(Constant.SYSTEM_UPGRADE_MSG);
		if(StringUtil.isBlank(switchs)) return null;
		if(!switchs.equals(SwitchEnum.ON.getCode()))return null;
