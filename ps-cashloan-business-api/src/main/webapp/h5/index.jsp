...
<%
  ...
  String basePath = "https"+"://"+request.getServerName()+":"+request.getServerPort()+"/";
...
<div class="proView">
  <div class="proTop">
    ...
    <div class="noBtn">
      <a href="./FTH5/register.html?invitationCode=<%=invitationCode%>&channelCode=<%=channelCode%>">
  ...
  <div class="proBtm">
    <div class="txtTop">
      ...
      <p>91买呗是安全、方便、快捷的互联网小额短期信贷信息服务平台，主要解决年轻一族在日常生活中小额借款需求， 为急需用钱的用户提供低门槛、申请简便、随借随还的现金贷款服务。
      </p>
    </div>
    <div class="txtBtm">
      ...
      <ul>
        ...
        <li class="clearfix">
          <img src="../static/images/ico005.png" alt="" />
          <div class="txtBtmTxt">
            <h3>提升额度简单</h3>
            <p>一键提额、简单快捷</p>
          </div>
 ...
 <!--    <%--<a href="h5/invite.jsp?invitationCode=<%=invitationCode%>&channelCode=<%=channelCode%>" class="regBtn-a">立即注册</a>--%> -->
    <a href="./FTH5/register.html?invitationCode=<%=invitationCode%>&channelCode=<%=channelCode%>" class="regBtn-a">立即注册</a>
  </div>
</div>
