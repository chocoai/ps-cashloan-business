...
.container {
	margin: 16px;
		...
		<p class="_color">④邮政储蓄银行卡不支持自动扣款，怎么办？</br>可通过支付宝还款或打款至对公账号两种方式进行还款。支付宝账号：hzsy@smoney.cc 对公银行账号为杭州银行 3301040160007376182，还款后请与客服取得联系，将注册用户手机号、转账金额和转入银行卡信息截图提供给客服。客服电话：<span class='phone'> </span>（工作日9:00-18:00）</p>
		...
		<p class="_color">①如何进行支付宝转账？</br>进入支付宝首页，点击“转账”，选择“转到支付宝账户”，输入支付宝账号：hzsy@smoney.cc ,点击“下一步”，输入转账金额，并将姓名和注册手机号添加到备注中，点击“确认转账”，输入支付宝密码即可完成还款。</p>
		<p class="_color">②如何确认支付宝转账是否成功？</br>还款后请及时在“借款详情”页查看还款状态，当页面默认显示为申请页面时，则表示还款成功。如有疑问请联系客服。客服电话：<span class='phone'> </span>（工作日9:00-18:00）。</p>
	</div>
