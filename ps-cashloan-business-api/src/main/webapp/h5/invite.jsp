...
<script>
    ...
    function kdlcJsApiShareBack(){
        if (typeof(kdlcJsApi) != 'undefined') {
            kdlcJsApi.pageAddShare('{"isShare":1,"shareBtnTitle":"\u6309\u94ae\u6587\u6848","shareTitle":"\u5206\u4eabtitle","sharePageTitle":"\u5206\u4eab\u6709\u5956\u63cf\u8ff0","shareContent":"\u5206\u4eab\u63cf\u8ff0","shareUrl":"http:\/\/www.xiaoeqiandai.com","shareImg":"http:\/\/res.koudailc.com\/article\/20160506\/3572c6e05464b6.png","sharePlatform":["wx","wechatf","qq","qqzone","sina","sms"],"shareSuccessAlert":"\u5206\u4eab\u6210\u529f\u5f39\u6846\u6587\u6848","shareIsUp":1,"shareUpId":11,"shareUpType":1,"shareUpUrl":"http:\/\/www.xiaoeqiandai.com"}');
        };
    ...
    //新加
    var codeurl = '/com.adpanshi.com.adpanshi.cashloan.api/user/sendSms.htm';//获取验证码
    var signup = '/com.adpanshi.com.adpanshi.cashloan.api/user/validateSmsCode.htm';//判断验证码手否正确
    var checkurl = '/com.adpanshi.com.adpanshi.cashloan.api/user/h5SendSms.htm';
    //app注册接口
    //var reg ='/com.adpanshi.com.adpanshi.cashloan.api/user/register.htm';
    //微信渠道注册接口
    var reg ='/com.adpanshi.com.adpanshi.cashloan.api/user/wxRegister.htm';
 ...
 // 刷新图片  
    function changeImg() {  
        ...
        imgSrc.attr("src", '/com.adpanshi.com.adpanshi.cashloan.api/h5/imgCode/generate.htm?timestamp='+times);
    }
    //头部图片
