package com.adpanshi.cashloan.core.common.context;
...
public class Constant {
    ...
    /** 交易密码错误 */
    public static final int FAIL_CODE_PWD = 401;

    /** 无权限访问 */
    public static final int PERM_CODE_VALUE = 403;

    /** 在黑名单中不予操作 */
    public static final int BiZ_IN_BLACKLIST = 404;

    /** token已过期 */
    public static final int TOKEN_HAVE_EXPIRED_CODE=411;

    /** token已过期 */
    public static final String TOKEN_HAVE_EXPIRED="token have expired";

    /** token不存在 */
    public static final int TOKEN_NONENTITY_CODE=413;

    /** token不存在 */
    public static final String TOKEN_NONENTITY="token nonentity";
