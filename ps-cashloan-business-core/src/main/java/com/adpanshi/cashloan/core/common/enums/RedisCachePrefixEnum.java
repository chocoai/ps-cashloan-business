...
public enum RedisCachePrefixEnum {
	...
	/** "前缀value" "添加对象字段" "描述" ENTITY_INSTANCE_EUser_632673243 */
	EntityCache("ENTITY_INSTANCE_","[CLASSNAME]_[ID]","根据对象实例ID存储"),

	/** USER_TOKEN_3FD2936E9B64268F07887E53136B2E11:FG */
	TokenCache("USER_TOKEN_","[Token]","根据TokenID存储"),
	...
	/** "前缀value" "添加对象字段" "描述" ENTITY_INSTANCE_BYUSER_ESellerUser_632673243 */
	EntityCacheByUser("ENTITY_INSTANCE_BYUSERID_","[CLASSNAME]_[ID]","根据对象实例ID存储"),
