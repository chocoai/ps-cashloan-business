...
import com.adpanshi.cashloan.cl.domain.EnjoysignDownloadLog;
import com.adpanshi.cashloan.cl.domain.EnjoysignRecord;
import com.adpanshi.cashloan.cl.mapper.EnjoysignDownloadLogMapper;
import com.adpanshi.cashloan.cl.mapper.EnjoysignRecordMapper;
import com.adpanshi.cashloan.cl.model.EnjoysignRecordModel;
import com.adpanshi.cashloan.cl.service.EsignRecordService;
import com.adpanshi.cashloan.cl.util.DateFormatUtil;
...
import com.adpanshi.cashloan.core.common.util.HttpsUtil;
import com.adpanshi.cashloan.core.common.util.StringUtil;
import com.adpanshi.cashloan.core.common.util.base64.Base64Util;
import com.adpanshi.cashloan.core.enjoysign.EnjoysignUtil;
import com.adpanshi.cashloan.core.enjoysign.enums.StatusEnum;
...
import com.adpanshi.cashloan.system.mapper.SysAttachmentMapper;
...
public class EsignRecordServiceImpl extends BaseServiceImpl<EnjoysignRecord,Long> implements EsignRecordService {
    ...
    Logger logger= LoggerFactory.getLogger(EsignRecordServiceImpl.class);
    ...
    public Map<String,Object> startSignWithAutoSilentSign(Long userId) {
        ...
        try {
            ...
            if(null==iExist){
                ...
                //发送请求
                String result = HttpUtil.postClient(esign_url,param);
                //解析返回数据
                if(result!=null){
