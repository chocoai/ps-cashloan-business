...
public class AlipayDownLoanFile {
	...
	public static List<AlipayModel> parseAlipayByUrl(String urlStr) throws IOException, ParameterException{
		...
		logger.info("======="+file);
		//String file="D:/现金贷/com.adpanshi.cashloan/framework-manage/src/main/webapp/alipay/file/20881021698578250156_20170406_业务明细.csv";
		//解析
	...
	public static void main(String[] args) {
        try{
        	String filePath="D:/现金贷/com.adpanshi.cashloan/framework-manage/src/main/webapp/alipay/20881021698578250156_20170406.csv.zip";
        	//解压
    	     String  savePath="D:/现金贷/com.adpanshi.cashloan/framework-manage/src/main/webapp/alipay/file";//存放解压之后的文件
