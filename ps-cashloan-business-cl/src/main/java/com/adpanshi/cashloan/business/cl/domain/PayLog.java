 ...
 */
 public class PayLog implements Serializable {
	...
	/**
	 * 主借款标识 (将borrowId名称变更为borrowMainId) @author yecy 20171214
	 */
	...
	public PayLog(String orderNo,Long borrowMainId,Long userId,Double amount,String cardNo,String bank,Date payReqTime){
		...
		this.createTime=payReqTime;
		this.updateTime=payReqTime;
		this.source=PayLogModel.SOURCE_FUNDS_OWN;
		this.type=PayLogModel.TYPE_LINE_PAYMENT;
		this.state=PayLogModel.STATE_PAYMENT_WAIT;
		this.setScenes(PayLogModel.SCENES_REPAYMENT);
	}
