...
public class GeetestLib {
	...
	protected final String apiUrl = "http://com.adpanshi.com.adpanshi.cashloan.api.geetest.com"; //极验验证API URL
	protected final String baseUrl = "com.adpanshi.com.adpanshi.cashloan.api.geetest.com";
	...
	private int registerChallenge() {
		try {
			...
			gtlog("exception:register com.adpanshi.com.adpanshi.cashloan.api");
		}
		return 0;
	}
