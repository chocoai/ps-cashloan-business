 ...
 * @version 1.0.0
 * @date 2017年3月6日 上午11:27:28 Copyright 粉团网路 All Rights Reserved
 *
 */
public class PaymentModel extends BasePaymentModel {
	...
	public PaymentModel(String orderNo) {
		...
		String subUrl = "https://instantpay.lianlianpay.com/paymentapi/payment.htm";
		if ("dev".equals(Global.getValue("app_environment"))) {
			String proxyUrl = Global.getValue("proxy_url");
			if (StringUtils.isNotEmpty(proxyUrl)) {
				subUrl = proxyUrl + "paymentapi/payment.htm";
			}
		}
