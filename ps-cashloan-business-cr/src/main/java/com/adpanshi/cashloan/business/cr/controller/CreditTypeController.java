...
public class CreditTypeController extends BaseController {
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/creditType/creditTypeList.htm")
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/creditType/saveCreditType.htm")
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/creditType/updateCreditType.htm")
   public void updateCreditType(@RequestParam("id")Long id,
     ...
     * @param id
     * */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/creditType/findDetail.htm")
   ...
   /**
    * 额度类型编辑页面可以显示的借款类型-额度类型编辑
    * @param id 额度类型ID
    * @throws Exception
    */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/creditType/editBorrowType.htm")
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/creditType/findUnUsedBorrowType.htm")
