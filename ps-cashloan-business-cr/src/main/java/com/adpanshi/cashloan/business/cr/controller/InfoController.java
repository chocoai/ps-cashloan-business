...
import com.adpanshi.cashloan.business.cr.model.RuleInfoDetail;
...
public class InfoController extends BaseController {
   ...
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/info/page.htm", method=RequestMethod.POST)
   public void page(
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/info/save.htm", method=RequestMethod.POST)
   public void save(
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/info/update.htm", method=RequestMethod.POST)
   public void update(
    ...
    * @throws Exception
    */
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/info/updateState.htm", method=RequestMethod.POST)
    ...
    */
   @SuppressWarnings("unchecked")
   @RequestMapping(value = "/modules/manage/com.adpanshi.cashloan.api.cr/info/infoPage.htm", method=RequestMethod.POST)
    ...
    * 查询所有数据库中表和字段
    */
   @RequestMapping(value="/modules/manage/com.adpanshi.cashloan.api.cr/info/findAllDataTable.htm", method=RequestMethod.POST)
