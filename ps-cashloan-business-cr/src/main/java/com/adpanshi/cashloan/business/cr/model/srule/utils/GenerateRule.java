package com.adpanshi.cashloan.business.cr.model.srule.utils;

import com.adpanshi.cashloan.business.cr.model.srule.config.builder.RuleBuilder;
import com.adpanshi.cashloan.business.cr.model.srule.config.builder.RuleBuilderCreator;
...
import com.adpanshi.cashloan.business.cr.model.srule.model.Formula;
import com.adpanshi.cashloan.business.cr.model.srule.model.SimpleRule;
...
public class GenerateRule {
    ...
    public static boolean comparText(String formula,String scop,String value){
    	...
    	/*	if(StringUtil.isNumber(scop)&&StringUtil.isNumber(scop)){
    			...
    			Rule com.adpanshi.cashloan.api.com.adpanshi.cashloan.api.rule = GenerateRule.genNumRule(simpleRule);
    			result = com.adpanshi.cashloan.api.com.adpanshi.cashloan.api.rule.beginMatch();
    		}*/
    		//没有匹配的表达式
    	}
    	return result;
